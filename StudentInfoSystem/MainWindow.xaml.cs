...
namespace StudentInfoSystem
{
    ...
    public partial class MainWindow : Window
    {
        ...
        //        context.Students.Add(new Student("Stoyan", "Angelov", "Iliev", "FKST", "KSI", DegreeType.MASTER, StudentStatus.CERTIFIED, "121218055", 5, 10, 37));
        ...
        //{
        //    StudentInfoContext context = new StudentInfoContext();
        //    UserData.TestUsers.ForEach(st => context.Users.Add(st));
        //    context.SaveChanges();
        //}
